...
VdiPoolWidget build_pool_widget(const gchar *pool_id G_GNUC_UNUSED, const gchar *pool_name, GtkWidget *gtk_flow_box)
{
    ...
    vdi_pool_widget.main_widget = gtk_frame_new("");
    //g_free(header_label);
