...
!!! warning "Смена мажорной версии"
    Версия брокера 3.0.0 и выше не имеет обратной совместимости с предыдущими версиями брокера. В случае необходимости
    переноса рекомендуется установить параллельную установку с брокером 3.0.0 (после обновления ECP VeiL) и воспроизвести
