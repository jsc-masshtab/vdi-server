...
!!! info "Virtual appliance"
    Виртуальный аплайнс (virtual appliance, VA) VeiL Broker — это готовый образ виртуальной машины 
    (доступен в виде резервной копии ВМ), который необходимо распаковать в ECP VeiL.

1. Скаченную из личного кабинета последняя версия VA VeiL Broker необходимо добавить в файлы вашего хранилица ECP VeiL.
...
7. Web-интерфейс брокера будет доступен по https://server_ip_address. По умолчанию пользователь 
