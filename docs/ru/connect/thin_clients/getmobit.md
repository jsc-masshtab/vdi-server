...
!!! attention "Внимание!"
    Для получения доступа к указанным ниже документам и файлам необходимо иметь учетную запись на сайте [lk.getmobit.ru](https://lk.getmobit.ru/cabinet-user/index)
...
1. Для вышеуказанной виртуальной машины необходим статический IP-адрес, а также желательно наличие A-записи в DNS, связывающей IP-адрес сервера управления GM Server с именем getmobit.example.site 
