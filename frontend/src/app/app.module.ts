...
import {
          ...
          faChevronCircleLeft, faChevronCircleRight, faAddressCard, faCheck, faUsersCog, faCrown, faColumns, faUpload, faIdCard
...
export class AppModule {
  constructor() {
    library.add(faDesktop, faDatabase, faLayerGroup, faPlusCircle, faMinusCircle, faSpinner, faServer, faCog, faChevronUp, faTimesCircle,
      ...
      faAddressCard, faCheck, faUsersCog, faCrown, faColumns, faUpload, faIdCard);
    }
}
