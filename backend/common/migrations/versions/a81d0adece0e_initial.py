...
def downgrade():
    ...
    op.drop_column('entity_role_owner', 'role')
    ...
    op.drop_column('mapping', 'value_type')
    op.execute("DROP TYPE valuetypes CASCADE")
    ...
    op.execute("DROP TYPE entitytype CASCADE")
    ...
    op.execute("DROP TYPE directorytypes CASCADE")
    op.drop_column('authentication_directory', 'connection_type')
    op.execute("DROP TYPE connectiontypes CASCADE")
