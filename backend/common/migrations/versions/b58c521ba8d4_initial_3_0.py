...
def upgrade():
    ...
    op.create_table('active_tk_connection',
                    ...
                    sa.Column('connected', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
                    sa.Column('data_received', sa.DateTime(timezone=True), server_default=sa.text('now()'),
                              nullable=False),
    ...
    op.create_table('authentication_directory',
                    ...
                    sa.Column('status',
                              sa.Enum('CREATING', 'ACTIVE', 'FAILED', 'DELETING', 'SERVICE', 'PARTIAL', 'BAD_AUTH',
                                      'RESERVED', name='status'), nullable=False),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('task',
                    ...
                    sa.Column('status',
                              ...
                              nullable=False),
                    sa.Column('task_type',
                              sa.Enum('POOL_CREATE', 'POOL_EXPAND', 'POOL_DELETE', 'POOL_DECREASE', 'VM_PREPARE',
                                      'VMS_BACKUP', name='pooltasktype'), nullable=False),
    ...
    op.create_index('ix_group_auth_mapping', 'group_authentication_directory_mappings',
                    ['authentication_directory_id', 'group_id', 'mapping_id'], unique=True)
    op.create_table('group_role',
                    sa.Column('id', postgresql.UUID(), nullable=False),
                    sa.Column('role', sa.Enum('SECURITY_ADMINISTRATOR', 'OPERATOR', 'ADMINISTRATOR', name='role'),
                              nullable=False),
                    sa.Column('group_id', postgresql.UUID(), nullable=False),
                    sa.ForeignKeyConstraint(['group_id'], ['group.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
    ...
    op.create_table('group_tk_permission',
                    ...
                    sa.Column('permission',
                              sa.Enum('USB_REDIR', 'FOLDERS_REDIR', 'SHARED_CLIPBOARD', name='tkpermission'),
                              nullable=False),
                    sa.Column('group_id', postgresql.UUID(), nullable=False),
                    sa.ForeignKeyConstraint(['group_id'], ['group.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('permission', 'group_id', name='permission_group_id_unique_constraint')
                    )
    op.create_index(op.f('ix_group_tk_permission_permission'), 'group_tk_permission', ['permission'], unique=False)
    op.create_table('pool',
                    ...
                    sa.Column('connection_types', postgresql.ARRAY(
                        sa.Enum('SPICE', 'SPICE_DIRECT', 'RDP', 'NATIVE_RDP', name='poolconnectiontypes')),
                        nullable=False),
    ...
    op.create_index(op.f('ix_tk_connection_statistics_conn_id'), 'tk_connection_statistics', ['conn_id'], unique=False)
    ...
    op.create_table('user_tk_permission',
                    sa.Column('id', postgresql.UUID(), nullable=False),
                    sa.Column('permission',
                              sa.Enum('USB_REDIR', 'FOLDERS_REDIR', 'SHARED_CLIPBOARD', name='tkpermission'),
                              nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('permission', 'user_id', name='permission_user_id_unique_constraint')
                    )
    op.create_index(op.f('ix_user_tk_permission_permission'), 'user_tk_permission', ['permission'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_tk_permission_permission'), table_name='user_tk_permission')
    ...
    op.drop_index(op.f('ix_tk_connection_statistics_conn_id'), table_name='tk_connection_statistics')
    ...
    op.drop_table('pool')
    op.drop_index(op.f('ix_group_tk_permission_permission'), table_name='group_tk_permission')
