...
def upgrade():
    ...
    # drop column
    op.drop_column('automated_pool', 'increase_step')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('automated_pool', sa.Column('increase_step', sa.INTEGER(), autoincrement=False, nullable=True))
    op.execute("UPDATE automated_pool SET increase_step = 1")
    op.alter_column('automated_pool', 'increase_step', nullable=False)
    # ### end Alembic commands ###
