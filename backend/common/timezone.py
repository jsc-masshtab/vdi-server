...
def get_corresponding_linux_time_zone(source_windows_time_zone):
    linux_time_zone = next(
        (linux_time_zone
         for windows_time_zone, linux_time_zone in WindowsLinuxTimeZoneIdTable
         if source_windows_time_zone in windows_time_zone),
        None
    )

    return linux_time_zone


def get_corresponding_windows_time_zone(source_linux_time_zone):
    windows_time_zone = next(
        (windows_time_zone
         for windows_time_zone, linux_time_zone in WindowsLinuxTimeZoneIdTable
         if source_linux_time_zone in linux_time_zone),
        None
    )

    return windows_time_zone


WindowsLinuxTimeZoneIdTable = [
    ...
    ("Central Asia Standard Time", "Asia/Qostanay"),
    ...
    ("GTB Standard Time", "Asia/Famagusta"),
    ...
    ("SA Eastern Standard Time", "Antarctica/Palmer"),
    ...
    ("West Asia Standard Time", "Asia/Atyrau"),
