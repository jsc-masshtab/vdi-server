...
thin_client_api_urls = [
    ...
    (r'/client/pools/(?P<pool_id>[0-9]+)/?', PoolGetVm),  # TODO: change to \d?
    (r'/client/pools/(?P<pool_id>[0-9]+)/(?P<action>[a-z]+)/?', ActionOnVm),  # action must be in lower case  # TODO: change to \d?
