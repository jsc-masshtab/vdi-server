...
snapshots["test_request_clusters 1"] = {
    "clusters": [
        {
            "controller": {"verbose_name": "controller_added_during_test"},
...
snapshots["test_request_clusters 3"] = {"cluster": {"verbose_name": "cluster_115"}}
...
snapshots["test_request_templates 3"] = {
    "template": {"status": "ACTIVE", "verbose_name": "alt_linux"}
}
