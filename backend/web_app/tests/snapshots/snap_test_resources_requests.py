...
snapshots['test_request_clusters 4'] = {
    'clusters_with_count': {
        'clusters': [
            {
                'verbose_name': 'cluster_115'
...
snapshots['test_request_datapools 4'] = {
...
snapshots['test_request_nodes 4'] = {
    'nodes_with_count': {
        'count': 1,
        'nodes': [
            {
...
snapshots['test_request_templates 4'] = {
