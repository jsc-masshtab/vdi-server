...
snapshots["TestUserSchema.test_user_change_password 1"] = {
    "changeUserPassword": {"ok": True}
}

snapshots["TestUserSchema.test_user_deactivate 1"] = {"deactivateUser": {"ok": True}}

snapshots["TestUserSchema.test_user_activate 1"] = {"activateUser": {"ok": True}}
...
snapshots["TestUserSchema.test_user_role 1"] = {
    "addUserRole": {
        ...
        "user": {
            ...
            "possible_roles": ["SECURITY_ADMINISTRATOR", "ADMINISTRATOR"],
            "username": "test_user",
        },
    }
}
...
snapshots["TestUserSchema.test_user_role 2"] = {
    "removeUserRole": {
        ...
        "user": {
            "assigned_roles": [],
            "possible_roles": ["SECURITY_ADMINISTRATOR", "OPERATOR", "ADMINISTRATOR"],
            "username": "test_user",
        },
    }
}
...
snapshots["TestUserSchema.test_users_list 1"] = {
    "users": [{"is_active": True, "is_superuser": True, "username": "vdiadmin"}]
}
