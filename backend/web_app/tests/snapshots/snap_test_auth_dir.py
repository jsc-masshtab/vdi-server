...
snapshots[
    "TestAuthenticationDirectoryQuery.test_auth_dir_get_possible_ad_groups_bad_pass 1"
] = {
    "auth_dir": {
        "assigned_ad_groups": [],
...
snapshots[
    "TestAuthenticationDirectoryDelete.test_drop_auth_dir_with_synced_group 1"
] = {"deleteAuthDir": {"ok": True}}
...
snapshots["TestAuthenticationDirectoryEdit.test_auth_dir_edit 1"] = {
    "updateAuthDir": {"auth_dir": {"status": "ACTIVE"}, "ok": True}
}
...
snapshots["TestAuthenticationDirectoryEdit.test_auth_dir_edit_bad_address 1"] = {
    "updateAuthDir": {"auth_dir": {"status": "FAILED"}, "ok": True}
}
...
snapshots["TestAuthenticationDirectoryMappings.test_add_auth_dir_mapp 1"] = {
    "addAuthDirMapping": {
        "auth_dir": {
            "id": "10913d5d-ba7a-4049-88c5-769267a6cbe4",
            "mappings": [{"verbose_name": "test_mapping2"}],
        },
        "ok": True,
    }
}
...
snapshots["TestAuthenticationDirectoryMappings.test_edit_auth_dir_mapp 1"] = {
    "editAuthDirMapping": {
        "auth_dir": {
            ...
            "mappings": [
                {
                    "assigned_groups": [{"id": "10913d5d-ba7a-4049-88c5-769267a6cbe4"}],
                    "id": "10913d5d-ba7a-4049-88c5-769267a6cbe4",
                    "possible_groups": [],
...
snapshots["TestAuthenticationDirectoryMappings.test_del_auth_dir_mapp 1"] = {
    "deleteAuthDirMapping": {
        "auth_dir": {"id": "10913d5d-ba7a-4049-88c5-769267a6cbe4", "mappings": []},
        "ok": True,
    }
}

snapshots["TestAuthenticationDirectoryUtils.test_auth_dir_check 1"] = {
    "testAuthDir": {"auth_dir": {"status": "ACTIVE"}, "ok": True}
}
