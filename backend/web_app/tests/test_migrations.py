...
def get_revisions():
    ...
    """
    tmp_url = "postgresql://{USER}:{PASS}@{HOST}/tests".format(
        USER=DB_USER, PASS=DB_PASS, HOST=DB_HOST
    )
    options = SimpleNamespace(
        config="alembic.ini", pg_url=tmp_url, name="migrations", raiseerr=False, x=None
    )
