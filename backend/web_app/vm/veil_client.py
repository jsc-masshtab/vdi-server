...
#         vm_obj = await vm.models.Vm.get(vm_id)
#         pool_obj = await pool.PoolModel.get(vm_obj.pool_id)
#         controller_obj = await Controller.get(pool_obj.controller)
...
#         await system_logger.debug('Enable remote access for {}'.format(self.verbose_name))
...
#             await system_logger.debug('Remote access is enabled. Skip.')
#             return True
#         await system_logger.debug('Remote access is disabled. Will enable.')
#         return False
#
